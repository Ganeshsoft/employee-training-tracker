...
ActiveRecord::Schema.define(:version => 20121201152953) do
  ...
  add_index "competencies", ["department_id"], :name => "index_competencies_on_department_id"
  ...
  create_table "training_records", :force => true do |t|
    ...
    t.integer  "trained_by_id",   :null => false
  ...
  add_index "training_records", ["certified_by_id"], :name => "index_training_records_on_certified_by_id"
  add_index "training_records", ["competency_id"], :name => "index_training_records_on_competency_id"
  add_index "training_records", ["trained_by_id"], :name => "index_training_records_on_trained_by_id"
